...
class _$SpecificationImpl implements _Specification {
  const _$SpecificationImpl({required this.type, required this.value});
  ...
  @override
  String toString() {
    return 'Specification(type: $type, value: $value)';
  }
...
abstract class _Specification implements Specification {
  const factory _Specification(
      ...
      required final String? value}) = _$SpecificationImpl;
